...
/** This is a test class to check if the code works as intended  */

import java.util.Scanner;

public class MovieTest extends MovieSorter{	
			...
			public static void main(String[] str){
				...
				System.out.printf("How do you want the movie to be sorted \n");
				System.out.printf("Press 1 for YEAR, Press 2 for TITLE, Press 3 for SCORE \n ");
				
				Scanner scan = new Scanner(System.in);
				int a = scan.nextInt();
				
				
				/** checking for all cases */
				
				while (!((a==1) || (a==2) || (a==3))){
					System.out.printf("Please enter again. You made a mistake");
					a = scan.nextInt();
				}	
				
					if(a==1){
						
						System.out.print("MOVIE SORTED BY YEAR");
						...
						System.out.print("MOVIE SORTED BY TITLE");
						for(i=0; i<MOVIES.length; i++){
						...
						System.out.print("MOVIE SORTED BY SCORE");
						for(i=0; i<MOVIES.length; i++){
							sorter.sortByScore(MOVIES);
							MOVIES[i].print();
						}		
					}					
			}
